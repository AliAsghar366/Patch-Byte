(() => {
            ...
            1639: (e, t, r) => {
                ...
                e.exports = function(e, t, r) {
                    var v, g, b, y, w, _, x, k = r && r.that,
                        ...
                        O = function(e) {
                            return E ? (i(e), I ? P(e[0], e[1], C) : P(e[0], e[1])) : I ? P(e, C) : P(e)
                        };
                    if (S) v = e.iterator;
                    else if (A) v = e;
                    else {
                    ...
                    j = function(e, t, r, n) {
                        ...
                        if (l(f)) {
                            var g = d(f),
                                b = m ? n.nodes : g ? [] : {};
                            if (g)
                                for (o = b.length, s = h(f), a = 0; a < s; a++) R(f, a, j(f, "" + a, r, a < o ? b[a] : void 0));
                            else
                                for (i = k(f), s = h(i), a = 0; a < s; a++) u = i[a], R(f, u, j(f, u, r, p(b, u) ? b[u] : void 0))
                        }
                        return c(r, e, t, f, v)
                    },
                    R = function(e, t, r) {
    ...
    r.amdO = {}, r.n = e => {
        ...
        const B = /^(?:\/[a-zA-Z]+(?:-[a-zA-Z]+)?)?\/+cart\/+add(?:\.js|\.json)?\/*$/,
            z = /^(?:\/[a-zA-Z]+(?:-[a-zA-Z]+)?)?\/+cart\/+change(?:\.js|\.json)?\/*$/,
            q = /^(?:\/[a-zA-Z]+(?:-[a-zA-Z]+)?)?\/+cart\/+update(?:\.js|\.json)?\/*$/,
        ...
        function W(e, t) {
            ...
            function(e, t, r) {
                ...
                const o = function(e, t, r) {
                    return function(...n) {
                        return e.apply(this, Array.prototype.slice.call(n)).then(e => {
                            ...
                            let i, s = !1;
                            if (o.match(B) && arguments[1] ? .body && e.redirected && (i = k(arguments[1].body), s = M(t, i, r, "add-fetch-redirect")), s) return e;
                            try {
                                if (o.match(B)) {
                                    try {
                                        ...
                                        const n = A(r);
                                        t.clone().json().then(t => R(e, t, n, "add-fetch")).catch(U)
                                    }(t, e, arguments[1].body)
                                } else o.match(z) ? function(e, t) {
                                    t.clone().json().then(t => {
                                        D(e, t, "change-fetch")
                                    }).catch(U)
                                }(t, e) : o.match(q) ? function(e, t) {
                                    t.clone().json().then(t => {
                                        $(e, t, "update-fetch")
                                    }).catch(U)
                ...
                n && n.indexOf("/cart/add") >= 0 && g(r, "submit", r => {
                    ! function(e, t, r) {
        ...
        function $e(e, t, r) {
            ...
            return o.push(Re(n, t).then(e => {
                ...
                var c, u;
                if (s && (c = s, null !== (u = window.Shopify) && void 0 !== u && u.customerPrivacy || (window.Shopify = window.Shopify || {}, window.Shopify.customerPrivacy = {}), window.Shopify.customerPrivacy.cachedConsent = c), je(t) && !ye()) {
                    const e = 31536e6,
            ...
            })), je(t) && ye() && o.push(Re(t.granular_consent.storefrontRootDomain || window.location.host, t)), Promise.race(o).catch(e => {
                var t;
        ...
        const De = ["marketing", "analytics", "preferences", "sale_of_data"],
            Me = [...De, "email", "rootDomain", "checkoutRootDomain", "storefrontRootDomain", "storefrontAccessToken", "headlessStorefront", "isExtensionToken", "metafields", "customerAccountRequestInfo"],
            Ue = De.map(e => `"${e}"`).join(", "),
        ...
        function tt() {
            window.Shopify = window.Shopify || {}, !window.Shopify.evids && (Ze = {}, Qe = {
                ...
                if (! function(e) {
                    ...
                    }(e) || (null == t ? void 0 : t.analyticsFramework) !== Xe && "wpm" !== (null == t ? void 0 : t.analyticsFramework) && (null == t ? void 0 : t.analyticsFramework) !== Ye && (null == t ? void 0 : t.analyticsFramework) !== Ge) return et("shu");
                const r = function(e) {
        ...
        function bt() {
            return new Promise(e => {
                vt.add(e), "visible" === document.visibilityState ? (document.addEventListener("visibilitychange", gt), requestAnimationFrame(() => setTimeout(() => {
                    vt.delete(e), e()
                }))) : gt()
            })
        }
        ...
        function xt(e) {
            ...
            function i(e, t) {
                if (wt(e)) {
                    ...
                    for (const r of Array.from(e.querySelectorAll(yt))) r instanceof HTMLAnchorElement && t(r)
                }
            }
            let s = [],
                a = [],
            ...
            const u = new MutationObserver(e => {
                    if (!t) try {
                        let u = !1;
                        for (const t of e) {
                            for (const e of Array.from(t.addedNodes)) _t(e) && (s.push(e), u = !0);
                            for (const e of Array.from(t.removedNodes)) _t(e) && (a.push(e), u = !0)
                        }
                        u && (c || (c = bt().then(() => {
                            c = null,
                                function() {
        ...
        let Et;
        const St = () => (void 0 === Et && (Et = function() {
                let e = !1;
                try {
                    const t = {
                            get passive() {
        ...
        function It(e, t, r, n) {
            const o = n.addEventListenerOptions ? { ...At,
            ...
            try {
                ...
                return e.addEventListener(t, i, St() ? o : o.capture), () => {
        ...
        class Ut {
            constructor() {
                Object.defineProperty(this, Mt, {
                    ...
                    writable: !0,
                    value: !1
                }), Pt(this, Tt)[Tt] = new IntersectionObserver(e => Pt(this, Rt)[Rt](e), {
                    threshold: .5
                })
            }
            watch(e, t) {
                ...
                return n || (n = new Set, Pt(this, Nt)[Nt].set(e, n), Pt(this, Tt)[Tt].observe(e)), n.add(r), () => {
                ...
                for (const t of e) {
                    ...
                    if (e)
                        if (t.intersectionRatio < .5)
                            ...
                            for (const r of [...e]) Pt(this, $t)[$t](r, t)
                }
        }
        ...
        function Bt(e, t) {
            ...
            try {
                ...
                return e.onError ? .(new mt("VisibilityObserverError", n)), void Pt(this, Mt)[Mt](e)
            }
        ...
        function qt(e) {
            ...
            t && (t.delete(e), 0 === t.size && (Pt(this, Nt)[Nt].delete(e.el), Pt(this, Tt)[Tt].unobserve(e.el)))
        }
        ...
        function Ft(e) {
            return e === Vt && nt("6faea013") ? Vt : e === Wt && nt("3b3c7daf") ? Wt : void 0
        }
        class Kt extends c {
            constructor(e, t) {
                super(t instanceof Error ? t.message : String(t), {
        ...
        const mr = (e, t) => {
            ...
            gr = (e, {
                ...
                const r = "v1/" + (t ? `${t}/` : "");
                return null == e || vr.includes(typeof e) || Array.isArray(e) ? `${r}UnknownError` : "string" == typeof e ? `${r}${e}` : "groupingHash" in e && "string" == typeof e.groupingHash ? `${r}${e.groupingHash}` : `${r}${"Error"!==e.name&&e.name?e.name:e.message}`
            };
        class br extends Error {
            constructor(...e) {
                super(...e), Error.captureStackTrace && Error.captureStackTrace(this, br)
            }
        }
        const yr = {
                severity: "error",
            ...
            wr = {
                ...
                notify: (e, t) => {
                    try {
                        ...
                        if (n.browserTarget === f.NotAvailable || n.browserTarget === f.Unknown || n.surface === u.NotAvailable || n.surface === u.Unknown || !_r(n.shopUrl)) return void(console ? .error && console.error(e));
                        const o = function(e, t) {
                            ...
                            }(r || self.navigator ? .userAgent), k = mr(e, n);
                            return {
                                payload_version: 5,
                                notifier: {
        ...
        function Lr(e, t = !1) {
            Ur ? .produce(e.schemaId, e.payload, {
                flush: t
            })
        }
        ...
        function Hr(e, t = new WeakMap) {
            ...
            for (const [o, i] of Object.entries(e)) {
                const e = zr(o);
                Array.isArray(i) ? n[e] = i.map(e => Hr(e, t)) : qr(i) ? n[e] = Hr(i, t) : n[e] = i
            }
            return n
        }
        var Vr = Ot("endpoint"),
        ...
        class Qr {
            constructor(e) {
                ...
                }), Pt(this, Vr)[Vr] = e.endpoint, Pt(this, Wr)[Wr] = e.batchTimeout ? ? 500, Pt(this, Fr)[Fr] = e.onError, self.addEventListener("pagehide", Pt(this, Yr)[Yr])
            }
            setEndpoint(e) {
                Pt(this, Vr)[Vr] = e
            }
            destroy() {
                self.removeEventListener("pagehide", Pt(this, Yr)[Yr]), void 0 !== Pt(this, Jr)[Jr] && (clearTimeout(Pt(this, Jr)[Jr]), Pt(this, Jr)[Jr] = void 0)
            }
            produce(e, t, {
                flush: r,
                ...
                const o = n ? Hr(t) : t;
                Pt(this, Vr)[Vr] ? (Pt(this, Kr)[Kr].push({
                    schema_id: e,
                    payload: o,
                    metadata: {
                        event_created_at_ms: (new Date).getTime()
                    }
                }), r ? this.flush() : void 0 === Pt(this, Jr)[Jr] && (Pt(this, Jr)[Jr] = setTimeout(() => this.flush(), Pt(this, Wr)[Wr]))) : console.log("[MonorailClient]", e, o)
            }
            flush() {
                if (void 0 !== Pt(this, Jr)[Jr] && (clearTimeout(Pt(this, Jr)[Jr]), Pt(this, Jr)[Jr] = void 0), 0 === Pt(this, Kr)[Kr].length) return;
                const e = {
        ...
        function en(e) {
            ...
            return !!tr(() => self.navigator.sendBeacon.bind(self.navigator)(r, e), !1) || !t && Pt(this, Zr)[Zr](r, e)
        }
        ...
        function nn(e, t) {
            return `${function(e,t){const r={global:"https://monorail-edge.shopifysvc.com",wellKnown:`${e}/.well-known/shopify/monorail`,staging:"https://monorail-edge-staging.shopifycloud.com",test:"https://localhost"},n=t||"wellKnown";return n in r?r[n]:r.wellKnown}(rn(e),t)}/unstable/produce_batch`
        }
        let on;
        ...
        class bn {
            constructor({
                ...
                this.channelSubscribers = new Map, this.bufferSize = e, this.replayKeep = t, this.subscribeAllKey = r, this.replayQueue = new gn(e, t), this.onSubscriberError = n, this.middlewareChain = e => e()
            }
            use(...e) {
        ...
        var yn = (e => (e.Standard = "standard", e.Advanced = "advanced", e))(yn || {});
        ...
        function _n(e, {
            ...
            function s(t) {
                t.source === e.contentWindow && t.data === wn && (window.removeEventListener("message", s), i())
            }
        ...
        function jn(e) {
            ...
            function o(t, r) {
                if ("object" == typeof t) {
                    ...
                    if (Tn(t)) return Object.keys(t).reduce((e, n) => ({ ...e,
                        [n]: o(t[n], r)
                    }), {})
                }
                return t
        ...
        async function Wn({
            ...
            if (s) {
                if (t.privileges) {
                    if (! function(e) {
                            return "sandbox" in e
                        }(i)) throw new br("browser does not support the sandbox attribute on IFrames");
                ...
                function(e, t) {
                    ...
                    r.setAttribute("id", Ln), Un(r, {
                        ...
                        function o(t) {
                            ...
                            r && r(t.clientX - qn, t.clientY - qn), n[1] = n[3] - t.clientX, n[2] = n[4] - t.clientY, n[3] = t.clientX, n[4] = t.clientY;
                        ...
                        return e => {
                            e.preventDefault(), n[3] = e.clientX, n[4] = e.clientY, self.addEventListener("mouseup", i), self.addEventListener("mousemove", o), Un(t, zn, {
                                important: !0
                            })
                        }
                    }({
        ...
        const Kn = ({
                ...
                async setHelperReady() {
                    t.container.showPopover(), Un(t.container, {
                        visibility: "visible",
                        opacity: "1"
                    }, {
                        important: !0
                ...
                async proceedWithoutConsent() {
                    try {
                        ...
                        function(e, t) {
                            ...
                            const r = new pe;
                            if (Ie() && r.produce("setTrackingConsent", "v0.2"), function(e) {
        ...
        function Qn(e) {
            try {
                ...
                t = "Session storage is not available. The Pixel Helper experience may be degraded.", Jn.has(t) || (Jn.add(t), "console" in self && console.warn(t))
            }
            var t
        }
                    ...
                    async init(r) {
                        const n = (() => {
                            try {
                                return (e => {
                                    ...
                                    const o = tr(() => JSON.parse(sessionStorage.getItem(Xn) ? ? "null"), null);
                                    if (!n && !o) return null;
                                    const i = {
                                        position: null,
                                        height: 216,
                                    ...
                                    if (!s || !Zn.includes(s.type) || s.id.match(/shopify/i)) throw eo(), new Gn(i, i.pixel);
                        ...
                        await Fn({
                            ...
                            this.message("initializeHelper", {
                                ...
                                loggerLevel: tr(() => "true" === self.localStorage.getItem("pixel-helper-advanced") ? yn.Advanced : yn.Standard, yn.Standard)
        ...
        const ao = "[object Undefined]",
            ...
            lo = e => null === e ? co : void 0 === e ? ao : Object.prototype.toString.call(e);
        ...
        function po(e) {
            ...
            return void 0 === e || n(e) ? {
                isValid: function e(o, i = "root") {
                    ...
                    const s = lo(o),
                        a = uo.includes(s);
                    return a || (r = i, t = `Value of type "${s}" at "${r}" must be one of the following types: ${uo.join(", ")}.`), a
                }(e, "root"),
                error: t,
                errorKey: r
            } : (r = "root", t = `Value of type "${lo(e)}" at "${r}" must be an object.`, {
                isValid: !1,
                error: t,
                errorKey: r
            })
        ...
        const fo = cr(e => {
            ...
            ho = ["page_viewed", "product_viewed", "collection_viewed", "cart_viewed", "clicked", "form_submitted", "input_blurred", "input_focused", "input_changed", "advanced_dom_clicked", "advanced_dom_scrolled", "advanced_dom_window_resized"];
        ...
        const vo = new Set(["innerHeight", "innerWidth", "scrollX", "scrollY", "pageXOffset", "pageYOffset"]);
        let go = {},
            bo = !1,
            yo = !0;

        function wo() {
            go.innerHeight = tr(() => window.innerHeight, 0), go.innerWidth = tr(() => window.innerWidth, 0);
            const e = tr(() => window.scrollX, 0),
                t = tr(() => window.scrollY, 0);
            go.scrollX = e, go.pageXOffset = e, go.scrollY = t, go.pageYOffset = t, yo = !1
        }
        ...
        const xo = new Proxy(window, {
            get: (e, t) => (bo || (bo = !0, wo(), window.addEventListener("resize", _o, {
                passive: !0
            }), window.addEventListener("scroll", _o, {
                passive: !0
            }), window.addEventListener("orientationchange", _o, {
                passive: !0
        ...
        const $o = /^\/checkouts\/([^/]+)\/([^/]+)(?:\/((?:[a-z]{2,3}|zh-hans|zh-hant)(?:-[a-zA-Z0-9]+)?))?(?:\/([^/]+))\/?$/,
            Do = (e, t, r, n, o) => {
                const {
        ...
        function Zo(t) {
            const {
                ...
                if (n && "string" == typeof n || (e(new No, {
                    ...
                    }()), !n || "string" != typeof n) return e(new jo, {
                    severity: "info",
                    unhandled: !1,
                    context: "isExcludedDuplicateConversion"
                }), !1;
                if (! function() {
                        try {
                            ...
                            return e.includes("checkouts") && e.some(e => Oo.includes(e))
                        } catch (e) {
                            return !1
                        }
                    }()) return !1;
                ...
                if (c) try {
                    ...
                    e.logError(new Wo(r, u instanceof Error ? u : new Error(String(u))), {
            ...
            return {
                publish(t, v, g) {
                    if (!nt(ot) && c !== u.CustomerAccount) return function(e, t, n) {
                        if ("string" != typeof e) throw new Go("Expected event name to be a string, but got " + typeof e, "LegacyPublishStandardEventError");
                        if (!o(e)) return !1;
                        const i = po(t);
                        if (!i.isValid) return console.error(i.error), !1;
                        const s = Io(e, t, n),
                            a = s.data ? .checkout ? .token;
                        return mo(s, r, c), Br("eventPublish", {
                            version: Gt,
                            bundleTarget: Zt,
                            pageUrl: self.location.href,
                            shopId: r,
                    ...
                    if ("string" != typeof t) {
                        ...
                        throw new Go(`Expected event name "${e}" to be a string, but got ${typeof t}`, "PublishEventError")
                    }
                    if (n(t) === e.Meta) return !1;
                    const b = po(v);
                    if (!b.isValid) {
                        if (s(t) || a(t)) {
                            const e = new Go(`Input Validation Error for event ${t}: ${b.error}\nPayload: ${JSON.stringify(v)}`, "PublishAdvancedDomEventError");
                            return wr.notify(e, {
                                type: "metric",
                ...
                publishCustomEvent(e, t, n) {
                    ...
                    if ("string" != typeof e) throw new Go("Expected event name to be a string, but got " + typeof e, "PublishCustomEventError");
                    if (!i(e)) return !1;
                    const o = po(t);
                    if (!o.isValid) return console.error(o.error), !1;
                    const s = Po(e, t);
                    return Br("eventPublish", {
                        version: Gt,
                        bundleTarget: Zt,
                        pageUrl: self.location.href,
                        shopId: r,
                ...
                publishDomEvent(e, t, n) {
                    ...
                    if ("string" != typeof e) {
                        ...
                        throw new Go(`Expected event name "${t}" to be a string, but got ${typeof e}`, "PublishDomEventError")
                    }
                    if (!s(e) && !a(e)) throw new Go(`Event name "${e}" is not a supported DOM Event`, "PublishDomEventError");
                    const o = po(t);
                    if (!o.isValid) {
                        const t = new Go(`Input Validation Error for event ${e}: ${o.error}`, "PublishDomEventError");
                        return wr.notify(t, {
                            type: "metric",
                ...
                subscribe(t, r, i = {}) {
                    const l = ft(),
                        d = async s => {
                            if (c === u.CheckoutOneSdk && i.scope !== no.CheckoutOneSdk) return;
                            await bt();
                            const a = {
                            ...
                            const f = n(s.name),
                                ...
                                m = p ? "FAILURE" : "SUCCESS",
                                v = p ? String(p) : void 0;
                            if ([e.Dom, e.AdvancedDom].includes(f)) or(1) && Br("subscriberEventEmitDom", { ...h,
                                status: m,
                                errorMessage: v
                            });
                            else {
                                let e;
                                o(s.name) && (e = s ? .data ? .checkout ? .token), Br("subscriberEventEmit", { ...h,
                                    eventType: f,
                    ...
                    return t === Xo ? f.subscribe(Xo, d, i) : t === Jo || o(t) ? p.subscribe(t, d, i) : t === Yo || s(t) ? h.subscribe(t, d, i) : f.subscribe(t, d, i)
                }
            }
        }
        ...
        function ri(e, t, r) {
            ...
            const a = function(e, t, r) {
                ...
                try {
                    ...
                    return wr.notify(new ti(o instanceof Error ? o : new Error(String(o))), {
        ...
        function ii(e, {
            ...
            const l = function(e) {
                return e === u.Shopify || e === u.CheckoutOne || e === u.CheckoutOneSdk || e === u.CheckoutOneShopApp ? oo.Checkout : e === u.StorefrontRenderer ? oo.Storefront : oo.Unknown
            }(a);
            return {
                analytics: {
                    subscribe(e, r, o) {
                ...
                browser: {
                    ...
                    localStorage: {
                        ...
                        getItem: async e => tr(() => window.localStorage.getItem(e), null),
                    ...
                    sessionStorage: {
                        ...
                        getItem: async e => tr(() => window.sessionStorage.getItem(e), null),
        ...
        async function pi(e, t) {
            ...
            const {
                ...
                shopId: s,
                surface: a
            } = e, l = o.id, p = o.type.toLowerCase(), f = Cr.WebPixels;
            var h, m;
            switch (o.restrictions || (o.restrictions = function(e, t) {
                const r = {};
                return Qo.includes(String(e)) && (r.allowedEvents = [], t !== u.StorefrontRenderer && (r.preventLoadingBeforeEvent = `shopify:app:pixels:load:${e}`)), r
            }(String(o.apiClientId), a)), await Promise.all([(async () => {
                await Pr(function(e) {
                    if (e) return Ar.reduce((t, r) => (t[r] = e.includes(r.toUpperCase()), t), {})
                }(o.privacyPurposes)), ro.message("logConsentGranted", {
                    pixelUid: {
                        id: l,
                        type: o.type
                    }
                    ...
                    try {
                        r = await async function(e, {
                            ...
                            const {
                                shopId: a,
                                storefrontBaseUrl: u
                            } = e, l = `web-pixel-sandbox-${t.type}-${t.id}-${t.runtimeContext}-${Qt}`;
                            ...
                            switch (t.runtimeContext) {
                                case d.Strict:
                                    [p, f] = await async function({
                                        ...
                                        const o = t.id,
                                            i = [rn(r), `/${n}`, `@${Qt}`, `/web-pixel-${o}`, `@${t.scriptVersion}`, "/sandbox", `/worker.${Zt}.js`].join(""),
                                            s = new Worker(i, {
                                                name: e,
                                                type: "classic",
                                                credentials: "omit"
                                            ...
                                            a = new Promise((e, t) => {
                                                const r = e => {
                                                    s.removeEventListener("error", r), t(e ? .filename && e ? .lineno && e ? .message ? new si(e.message, i) : new c(`Failed to load web worker for pixel ${o} with url ${i}}`, {
                                ...
                                case d.Lax:
                                    [p, f] = await async function({
                                        ...
                                        const {
                                            search: o
                                        } = self.location, i = t.id, s = t.type.toLowerCase(), a = [rn(r), `/${n}`, `@${Qt}`, `/${s}`, `/web-pixel-${i}`, `@${t.scriptVersion}`, "/sandbox", `/${Zt}`, /\.(js|json|xml)$/.test(self.location.pathname) ? "" : self.location.pathname, o].join(""), {
                                            iframe: u
                                        } = await Wn({
                                            containerSpec: {
                            ...
                            const b = t.runtimeContext === d.Lax ? (ai || (ai = {
                            ...
                            if (f && y.push(f), await Promise.race(y), Qt !== g.hashVersion) {
                                const e = new c(`The main bundle hash (${Qt}) does not match the sandbox hash (${g.hashVersion})`, {
                ...
                case d.Open:
                    try {
                        r = await async function(e, {
                            ...
                            const m = [rn(s), `/${i}@${Qt}`, `/${t.type.toLocaleLowerCase()}`, `/web-pixel-${d}@${t.scriptVersion}`, "~2", `/pixel.${Zt}.js`].join("");
                            if (!self[Xt]) {
                                const e = new c(`${Xt} was not found on the global scope. ${Xt}.createShopifyExtend() was not exposed to the window.`, {
                            ...
                            if (!("createShopifyExtend" in self[Xt])) {
                                const e = (e, t) => {
                                    ...
                                    return d || u(new c(`No api found for pixel ${i}.`, {
                                        ...
                                        extend: (e, t) => {
                                            "WebPixel::Render" !== e && u(new li(`Invalid extension point: ${e}`, {
                            ...
                            var v, g;
                            return await (v = m, g = e => {
                                e.dataset.pixelId = d, e.dataset.pixelType = p, f ? (e.integrity = f, e.crossOrigin = "anonymous") : wr.notify(new c(`Missing integrityHash for SRI-enabled open pixel of type ${p} with id ${d} and src ${m}`, {
                                ...
                                try {
                                    ...
                                    r.src = v, r.async = !0, r.onload = () => {
                                        e()
                                    }, r.onerror = () => {
                                        n(), t(new c(`Failed to load script: ${v}`, {
                ...
                default:
                    {
                        ...
                        throw ro.message("logPixelRegister", {
                            pixelUid: {
                                id: l,
                                type: o.type
                            },
            ...
            n && !r ? ro.message("logPixelRegister", {
                pixelUid: {
                    id: l,
                    type: o.type
                },
                status: "FAIL",
                errorType: n instanceof ui ? "PixelInitializationError" : "PixelRegistrationError",
                error: n
            }) : r && ro.message("logPixelRegister", {
                pixelUid: {
                    id: l,
                    type: o.type
                },
        ...
        const fi = new RegExp(["password", "pass", "pw", "ssn", "sin", "social", "security", "cc", "card", "creditcard", "cvv", "cvc", "cvn", "billing", "license", "health", "secret", "unique"].map(e => `^(.*[^a-z])?${e}([^a-z].*)?$`).join("|"), "i"),
            hi = function(e, {
                cache: t,
                cacheKey: r
            } = {}) {
                ...
                return !!Hn(e) && null !== e.closest('script, iframe, [data-shopify-privacy="exclude"]')
            }, {
                cacheKey: e => e
            }),
            mi = ["id", "name", "type"],
            vi = (e, t) => ("value" in t && "string" == typeof t.value && (e => {
                if (!Hn(e)) return !1;
        ...
        const xi = ["screenX", "screenY", "pageX", "pageY", "clientX", "clientY", "offsetX", "offsetY", "movementX", "movementY"],
        ...
        const Ri = [HTMLInputElement, HTMLSelectElement, HTMLTextAreaElement, HTMLButtonElement],
        ...
        const Mi = (e, t) => (r, {
                ...
                try {
                    const e = i ? .target;
                    if (!(e instanceof HTMLInputElement || e instanceof HTMLSelectElement || e instanceof HTMLTextAreaElement) || hi(e)) return;
                    n ? r(`${n}${t}`, {
                        node: Ni(e)
                    }) : r(t, {
                        element: Di(e)
            ...
            qi = [Ui, Bi, (e, {
                ...
                const n = r ? .target;
                n instanceof HTMLFormElement && !hi(n) && (t ? e(`${t}form_submitted`, {
                    node: Ni(n)
                }) : e("form_submitted", {
                    element: { ...bi(n, zi),
                        elements: Array.from(n.elements).filter(e => Ri.some(t => e instanceof t) && !hi(e)).map(e => Di(e))
                    }
                }))
            }, {
                onError: r
        ...
        const Ki = e => {
            ...
            Ji = [(e, {
                ...
                onError: t
            }) => It(document, "selectionchange", t => {
                const r = document.activeElement;
                r instanceof Element && !hi(r) && e("advanced_dom_selection_changed", {
                    node: Ni(r)
                })
            }, {
                onError: t,
                ...
                return "loading" !== document.readyState ? (r(), () => {}) : It(window, "DOMContentLoaded", r, {
                    onError: t
                })
            }, (e, {
                onError: t
                ...
                const r = new MutationObserver(r => {
                        bt().then(() => {
                            r.forEach(t => {
                                ...
                                const r = Wi(Array.from(t.addedNodes).filter(e => e.parentNode), Ki),
                                    n = function(e) {
                                        if (0 === e.removedNodes.length) return [];
                                        if (hi(e.target)) return e.removedNodes.forEach(e => Ti(e)), [];
                                ...
                                if ("attributes" === t.type) {
                                    ...
                                    r && e instanceof HTMLElement && t.oldValue !== e.getAttribute(r) && o.push(Ni(t.target))
                                }
                                if ("characterData" === t.type) {
                                    const {
                                        target: e
                                    } = t;
                                    e instanceof Text && t.oldValue !== e.data && o.push(Ni(e))
                                }
                ...
                const o = It(window, "DOMContentLoaded", n, {
                    onError: t
                });
                return () => {
                    o(), r.disconnect()
        ...
        class Zi {
            constructor(e, {
                ...
                this.eventBus = void 0, this.eventBus = new bn({
                    subscribeAllKey: "*",
                    onSubscriberError: t,
                    bufferSize: r,
                    replayKeep: n
        ...
        class rs {
            constructor(e, t) {
                Object.defineProperty(this, es, {
                    ...
                    writable: !0,
                    value: new Set
                }), Pt(this, es)[es] = e(), Pt(this, es)[es] || t(() => {
                    !Pt(this, es)[es] && e() && (Pt(this, es)[es] = !0, Pt(this, ts)[ts].forEach(e => e()), Pt(this, ts)[ts].clear())
                })
            }
            get isOpen() {
            ...
            onOpen(e) {
                return Pt(this, es)[es] ? (e(), () => {}) : (Pt(this, ts)[ts].add(e), () => {
        ...
        class ss {
            constructor(e, t) {
                Object.defineProperty(this, os, {
                    ...
                    writable: !0,
                    value: void 0
                }), Pt(this, os)[os] = e, Pt(this, is)[is] = t
            }
            register(e) {
                Pt(this, is)[is].surface === u.CustomerAccount && e("log:event-bus:publish", ({
                    payload: {
                        event: e
                    }
                }) => {
                    if ("page_viewed" === e.name) {
                        const {
                            context: t
                        } = e, r = Pt(this, is)[is].analyticsProcessingAllowed(), n = Pt(this, is)[is].marketingAllowed(), o = Pt(this, is)[is].preferencesProcessingAllowed(), i = Pt(this, is)[is].saleOfDataAllowed(), s = !(n && r), a = {
                        ...
                        Pt(this, os)[os].produce("storefront_customer_tracking/4.27", { ...a,
                            emittedToV5: !0,
                            ccpaEnforced: !i,
                            gdprEnforced: s,
                            isPersistentCookie: "persistent" === (pn("_shopify_m") ? ? "persistent")
                        }), Pt(this, os)[os].produce("storefront_customer_tracking/5.4", a)
                    }
                })
            }
        }
        const as = ["checkout_completed", "checkout_started", "payment_info_submitted", "checkout_shipping_info_submitted", "checkout_contact_info_submitted", "checkout_address_info_submitted"],
            cs = new Set([...as, "page_viewed", "product_viewed", "collection_viewed", "product_added_to_cart", "search_submitted"]),
            us = {
        ...
        class fs {
            constructor(e, {
                ...
                Object.defineProperty(this, ds, {
                    ...
                    writable: !0,
                    value: void 0
                }), Pt(this, ds)[ds] = e, Pt(this, ps)[ps] = t
            }
            register(e) {
                e("log:event-bus:publish", ({
                    ...
                    } else if ("page_viewed" === e.name) Pt(this, ds)[ds].track({ ...r,
                        eventName: ls(e.name),
                        referrer: t.document.referrer
                    });
        ...
        class vs {
            constructor(e, t) {
                Object.defineProperty(this, hs, {
                    ...
                    writable: !0,
                    value: void 0
                }), Pt(this, hs)[hs] = e, Pt(this, ms)[ms] = t
            }
            track(e) {
                try {
                    const t = { ...e,
                        ...
                        preferencesAllowed: Pt(this, ms)[ms].preferencesProcessingAllowed(),
            ...
            persist(e) {
                try {
                    const t = sessionStorage.getItem(gs),
                        r = t ? JSON.parse(t) : [];
                    r.length >= 50 && r.shift(), r.push(e), sessionStorage.setItem(gs, JSON.stringify(r))
                } catch (t) {
                    Pt(this, bs)[bs] ? .(t)
                }
            }
        }
        const ws = new Set(["page_viewed", "product_viewed", "collection_viewed", "product_added_to_cart", "search_submitted"]);
        var _s = Ot("client"),
            xs = Ot("extractDetail");
        class ks {
            constructor({
        ...
        class Os {
            constructor(e, t) {
                Object.defineProperty(this, Cs, {
                    ...
                    writable: !0,
                    value: void 0
                }), Pt(this, As)[As] = e, Pt(this, Is)[Is] = t
            }
            register(e) {
        ...
        const js = "storefront_product_interaction_event_test/1.0",
            Rs = {
                [Vt]: "product_page_dwell",
                [Wt]: "collection_page_dwell"
            };
        ...
        class Ws {
            constructor(e, t) {
                Object.defineProperty(this, Hs, {
                    ...
                    writable: !0,
                    value: void 0
                }), Pt(this, Hs)[Hs] = e, Pt(this, Vs)[Vs] = t
            }
            track(e) {
                try {
                    Pt(this, Hs)[Hs](Mr("webPixelsPublicEventPayloadTransform", {
                        ...
                        adjustmentsJson: e.dataSharingAdjustments ? qs(e.dataSharingAdjustments) : void 0
                    }))
                } catch (t) {}
            }
            trackBlockedEvent(e) {
                try {
                    Pt(this, Hs)[Hs](Mr("webPixelsManagerSubscriberEventBlocked", {
                        eventId: e.eventId,
        ...
        class ra {
            constructor({
                ...
                Object.defineProperty(this, Zs, {
                    ...
                    writable: !0,
                    value: []
                }), Fs(this, Zs)[Zs] = e, Fs(this, Qs)[Qs] = null != t ? t : {}
            }
            addAttributes(e) {
                Fs(this, Qs)[Qs] = { ...Fs(this, Qs)[Qs],
                    ...e
                }
            }
            histogram({
            ...
            async exportMetrics() {
                Fs(this, ea)[ea].forEach(e => {
                    e.attributes = { ...Fs(this, Qs)[Qs],
                        ...e.attributes
                    }
                });
                const e = Fs(this, ea)[ea];
                Fs(this, ea)[ea] = [], await this.exportByKeepalive(e, (e, t) => Fs(this, Zs)[Zs].exportMetrics(this.aggregateMetrics(e), t))
            }
            async exportLogs() {
                const e = Fs(this, ta)[ta];
                Fs(this, ta)[ta] = [], await this.exportByKeepalive(e, (e, t) => Fs(this, Zs)[Zs].exportLogs(this.formatLogs(e), t))
            }
            aggregateMetrics(e) {
                const t = {};
                return e.forEach(e => {
                        ...
                        case "histogram":
                            ! function(e, t) {
                                ...
                                const {
                                    ...
                                    timeUnixNano: s,
                                    attributes: a
                                } = t, c = null !== (r = t.bounds) && void 0 !== r ? r : Gs, u = new Array(c.length + 1).fill(0);
                                e[n] || = {
                                    name: n,
                                    unit: i || "1",
                                    histogram: {
        ...
        class ca {
            constructor(e, t, r) {
                ...
                Object.defineProperty(this, na, {
                    ...
                    writable: !0,
                    value: void 0
                }), Fs(this, na)[na] = e.replace(/\/v1\/(logs|metrics|traces)\/?$/, ""), Fs(this, oa)[oa] = t, Fs(this, ia)[ia] = null == r ? void 0 : r.logger, Fs(this, sa)[sa] = null == r ? void 0 : r.fetchFn, Fs(this, aa)[aa] = null !== (n = null == r ? void 0 : r.maxPayloadSizeBytes) && void 0 !== n ? n : 51200
            }
            ...
            async exportTo(e, t, r) {
                ...
                if (i > Fs(this, aa)[aa]) throw new la(`Payload size ${i} exceeds ${Fs(this,aa)[aa]} bytes`);
                ...
                if (null === (n = Fs(this, ia)[ia]) || void 0 === n || n.log({
                        status: s.status
                    }), !s.ok) {
                    if (400 === s.status) {
                    ...
                    if (401 === s.status || 403 === s.status) {
                        const t = await s.text();
                        throw new da(`Authentication failed: ${s.status} ${401===s.status?"Unauthorized":"Forbidden"}`, {
                            errorData: t,
                            body: e
                        })
                    }
        ...
        class ga {
            constructor({
                ...
                Object.defineProperty(this, fa, {
                    ...
                    writable: !0,
                    value: void 0
                }), Pt(this, fa)[fa] = e, Pt(this, ha)[ha] = t, Pt(this, ma)[ma] = r ? ? "", Pt(this, va)[va] = n ? ? {}
            }
            record(e, t, ...r) {
                ...
                Pt(this, fa)[fa].exportMetrics().catch(() => {})
            }
            log(e, t) {
                Pt(this, fa)[fa].log({
                    body: e,
                ...
                }), Pt(this, fa)[fa].exportLogs().catch(() => {})
            }
        }
        var ba = Ot("client");
        class ya {
        ...
        class _a {
            ...
            exportMetrics(e) {
                return console.log(`[${Pt(this,wa)[wa]}] Metrics:`, e), Promise.resolve()
            }
            exportLogs(e) {
                return console.log(`[${Pt(this,wa)[wa]}] Logs:`, e), Promise.resolve()
            }
        }
        const xa = {
            feature_usage: {
        ...
        function Va(e, t) {
            try {
                ...
                const r = Ba() ? .serverTiming ? .find(e => "requestID" === e.name) ? .description;
                if (!r) return;
                return function(e, t) {
                    try {
                        const r = Wa(e, t);
        ...
        class Ya {
            constructor(e, t) {
                Object.defineProperty(this, Xa, {
                    ...
                    writable: !0,
                    value: void 0
                }), Pt(this, Fa)[Fa] = e, Pt(this, Ka)[Ka] = t
            }
            register(e) {
                e("log:trekkie:track", ({
                    payload: {
                    ...
                    s && ("checkout_completed" !== s || o) && Pt(this, Xa)[Xa](s, i, ka(n))
                })
            }
        }
        ...
        function Ga(e, t, r) {
            ...
            switch (n) {
                case "page_rendered":
                    return Pt(this, Ka)[Ka].isRemoteProduct() ? "remote_page_rendered" : n;
                case "product_page_rendered":
                    return Pt(this, Ka)[Ka].isRemoteProduct(ka(r.variantId)) ? "remote_product_page_rendered" : n;
                case "product_added_to_cart":
                    {
        ...
        function Za(e, t, r) {
            const n = function(e, t, r) {
                ...
                i = !(Pt(this, Ka)[Ka].marketingAllowed() && Pt(this, Ka)[Ka].analyticsProcessingAllowed());
            Pt(this, Fa)[Fa].produce("storefront_customer_tracking_parity/1.0", {
                ...
                ...za(),
                ...Pt(this, Ka)[Ka].isMerchantRequest && {
                    isMerchantRequest: !0
                },
        ...
        class tc {
            constructor(e, t = {}) {
                Object.defineProperty(this, Qa, {
                    ...
                    writable: !0,
                    value: void 0
                }), Pt(this, Qa)[Qa] = e, Pt(this, ec)[ec] = t
            }
            register(e) {
                e("log:trekkie:track", ({
                    payload: {
                    ...
                    Pt(this, ec)[ec].onEventReceived ? .(i), nt(it) && Pt(this, Qa)[Qa].produce(i, s, {
                        convertEventCase: !1
                    })
                })
            }
        ...
        class oc {
            constructor(e, t) {
                Object.defineProperty(this, rc, {
                    ...
                    writable: !0,
                    value: void 0
                }), Pt(this, rc)[rc] = e, Pt(this, nc)[nc] = t
            }
            register(e) {
                e("log:trekkie:track", ({
                    payload: {
                    ...
                    "string" == typeof r && Pt(this, rc)[rc].record("feature_usage", 1, {
                        feature: "event_emission",
                        event_name: r,
                        user_can_be_tracked: Pt(this, nc)[nc].analyticsProcessingAllowed() || Pt(this, nc)[nc].marketingAllowed()
                    })
                })
            }
        }
        ...
        const fc = () => {
            const e = (() => {
                ...
                t = (e => {
                    const t = e.trim().toLowerCase();
                    return r = t, uc.includes(r) ? t : window.Shopify ? .Checkout ? u.Shopify : window.Shopify ? .analytics ? .replayQueue ? u.StorefrontRenderer : window.CardFields ? u.CheckoutOne : u.Unknown;
                    var r
                })(e ? .surface ? ? ""),
                r = (e => {
                    if (!e) return [];
            ...
            return {
                ...
                features: {
                    ...
                    cartPermalink: "false" !== e ? .cartPermalink && [...lc, u.CheckoutOne, u.CheckoutOneShopApp, u.Shopify].includes(t),
                    trekkieShim: "true" === e ? .trekkieShim,
                    agentContext: "true" === e ? .agentContext
                },
                scope: {
                    publish: e ? .publish === io.All ? io.All : io.Custom
                }
            }
        };
        try {
            ! function({
                ...
                wr.metadata = vn(e, ["shopId", "surface", "browserTarget", "shopDomain"]);
                try {
                    (({
                        storefrontBaseUrl: e
                    }) => {
                        ...
                        if (! function(e) {
                            ...
                            }(e)) throw new br(`storefrontBaseUrl is not a valid absolute URL: "${e}"`)
                    })(e);
                    const s = new Qr({
                    ...
                    const a = t ? ? ((e, {
                            ...
                            let i;
                            const s = () => (i || (i = (e => {
                                    return (t = "https://otlp-http-production.shopifysvc.com", new ya({
                                        throttleDelay: 1e3,
                                        client: new ra({
                                            exporter: t ? new ca(t, "web-pixels-manager") : new _a("WPM OTel")
                                        })
                                    })).createClient({
                                        metrics: xa,
                            ...
                            if (nt("f12a06f7") && a.push(Qi(new fs(new vs(Lr, { ...e,
                                    analyticsProcessingAllowed: He,
                                    marketingAllowed: qe,
                                    preferencesProcessingAllowed: Ve,
                                    saleOfDataAllowed: We
                            ...
                            if (e.features.storefrontEvents) {
                                (nt(st) || nt(at)) && a.push(Qi(new Os(t, { ...e,
                                    pageUrl: n ? ? "",
                                    analyticsProcessingAllowed: He,
                                    marketingAllowed: qe,
                                    preferencesProcessingAllowed: Ve,
                                ...
                                r && e.resourceId && a.push(Qi(new Us(t, { ...e,
                                    pageType: r,
                                    resourceId: e.resourceId,
                                    pageUrl: n ? ? "",
                                    analyticsProcessingAllowed: He,
                            ...
                            return a.push(new zs(new Ws(Lr, {
                                shopId: e.shopId,
                                surface: e.surface,
                                pageUrl: n ? ? ""
                            }))), (nt("d5bdd5d0") || nt(it)) && a.push(Qi(new Ya(t, { ...e,
                                analyticsProcessingAllowed: He,
                                marketingAllowed: qe,
                                preferencesProcessingAllowed: Ve,
                                saleOfDataAllowed: We,
                    ...
                    if (self[Xt]) {
                        ...
                        const r = new c(`WebPixelsManager: ${Xt} global object is already defined`, {
                    ...
                    const E = Mr("load", {
                        ...
                        A = {
                            init(t) {
                                ...
                                if (sc) return wr.notify(new c(`WebPixelsManager: ${Xt} is being initialized multiple times`, {
                                ...
                                const I = function() {
                                    ...
                                    return r.reverse().reduce((e, t) => {
                                        ...
                                        return function(e) {
                                            ...
                                            function(e) {
                                                dn(`${fn}=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT; domain=${e}`)
                                            }(r), r
                                    }, ""), hn.set(e, n), n
                                }();
                                y && tr(() => self.sessionStorage.setItem(rr, "true")), tt(), s.setEndpoint(nn(m, w)), (tr(() => "true" === self.sessionStorage.getItem(rr), !1) || f === u.CustomerAccount) && ro.init(A);
                                const P = ze().toString(),
                                    C = Mr("unload", {
                                        version: Gt,
                                        bundleTarget: Zt,
                                ...
                                O = C, window.addEventListener("pagehide", () => {
                                    O.payload.pageDuration = Nr("page:session") ? .measurement ? .duration, Lr(O, !0)
                                });
                                const T = Zo(k),
                                    N = function(e) {
                                        const t = new bn({
                                        ...
                                        return t.use(Do), {
                                            ...
                                            subscribe(r, n, o = {}) {
                                                ...
                                                return t.subscribe(r, t => {
                                                    if (e === u.CheckoutOneSdk && o.scope !== no.CheckoutOneSdk) return;
                                                    const r = {
                                                    ...
                                                    n.call(t, t), Br("subscriberEventEmitPrivacy", {
                                                        version: Gt,
                                                        bundleTarget: Zt,
                                                        pageUrl: self.location.href,
                                                        shopId: o.shopId,
                                ...
                                try {
                                    if (window.Shopify && !0 === window.Shopify.designMode) return window.console && console.log("[WebPixelsManager] Prevented from executing in the Theme Editor"), Yi;
                                    if (/^web-pixel-sandbox/.test(self.name)) {
                                        const e = new br("WebPixelsManager: browser library is being run in a sandbox");
                                        throw wr.notify(e, { ...R,
                                            type: "metric",
                                            library: "browser"
                                        }), e
                                    ...
                                    if (_.storefrontEvents) {
                                        try {
                                            ...
                                            context: {
                                                pageType: e.pageType,
                                                collectionId: e.pageType === Wt ? e.resourceId : void 0
                                            },
                                            onEvent: e => {
                                        ...
                                        }), Ft(e.pageType) && e.resourceId && function(e, {
                                            onError: t
                                        }) {
                                            let r = !1,
                                                n = 0,
                                            ...
                                            const c = It(document, "visibilitychange", function() {
                                                "visible" !== document.visibilityState ? (a(), o = 0) : !r && n < Jt.length && s()
                                            }, {
                                                onError: e => {
                                    ...
                                    return _.cartPermalink && function(e, {
                                    ...
                                    }(T.publish.bind(T), a), _.domEvents && Hi(r, s), _.advancedDomEvents && E.some(({
                                        capabilities: e
                                    }) => (e || []).includes(p.AdvancedDomEvents)) && (D = r, M = s, Ji.map(e => {
                                        try {
                                            return e(D, M)
                                        } catch (n) {
                                            return M ? .onError ? .(n, {
                                    ...
                                    })), $.payload.status = "initialized", Lr($), sc = function(e, {
                                        eventBus: t,
                                        customerId: r,
                                        scope: n
                                    }) {
                                        const o = function({
                                            ...
                                            c = (e, r, o) => !(a === u.CustomerAccount && !i(e) && n.publish !== io.All) && t.publish(e, r, o);
                                        return {
                                            ...
                                            subscribe: (e, r, n) => t.subscribe(e, r, { ...n,
                                                shopId: s,
                                                surface: a,
                                                scope: a === u.CheckoutOneSdk ? no.CheckoutOneSdk : void 0
                                            }),
                                    ...
                                    return n instanceof br || wr.notify(n, {
                                        context: "init",
                                        initConfig: A
                                    }), window.console && console.error(n), $.payload.status = "failed", $.payload.errorMsg = n ? .message, Lr($), C.payload.runtimeErrorCaught = "true", Yi
                                }
                                var D, M
                            }
                        };
                    return an(self, Xt, {
                        ...
                        configurable: !1,
                        enumerable: !1
                    }, !1), E.payload.status = "loaded", Lr(E), A
                } catch (n) {
                    ...
                    return wr.notify(n, {
                        ...
                        unhandled: !t
                    }), window.console && console.error(n), Lr(Mr("load", {
                        version: Gt,
                        bundleTarget: Zt,
                        pageUrl: r,
