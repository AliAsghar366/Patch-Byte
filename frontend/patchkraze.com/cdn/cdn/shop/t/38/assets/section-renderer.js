...
class SectionRenderer {#
    ...
    async renderSection(sectionId, options) {
        ...
        return abortController.signal.aborted || (this.#abortControllersBySectionId.delete(sectionId), morphSection(sectionId, sectionHTML)), sectionHTML
    }#
    ...
    async getSectionHTML(sectionId, useCache = !0, url = new URL(window.location.href)) {
        ...
        pendingPromise = fetch(sectionUrl).then(response => response.text()), this.#pendingPromises.set(sectionUrl, pendingPromise);
...
//# sourceMappingURL=/cdn/shop/t/38/assets/section-renderer.js.map?v=117273408521114569061768999423