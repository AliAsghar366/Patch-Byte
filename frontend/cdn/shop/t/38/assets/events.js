...
export class SlideshowSelectEvent extends Event {
    constructor(data) {
        super(SlideshowSelectEvent.eventName, {
            bubbles: !0
        }), this.detail = data
    }
    detail;
...
export class ZoomMediaSelectedEvent extends Event {
    constructor(index) {
        super(ThemeEvents.zoomMediaSelected, {
            bubbles: !0
        }), this.detail = {
            index
        }
...
export class MegaMenuHoverEvent extends Event {
    constructor() {
        super(ThemeEvents.megaMenuHover, {
            bubbles: !0
        })
    }
}
...
//# sourceMappingURL=/cdn/shop/t/38/assets/events.js.map?v=147926035229139604561768999423